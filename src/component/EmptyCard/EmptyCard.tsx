...
const EmptyCard = () => {
  return (
    <div className="w-full flex items-center flex-wrap justify-center gap-10 text-white h-screen">
      <div className="grid gap-4 w-full">
        ...
        <div>
          <h2
            className={`text-center  font-semibold leading-relaxed pb-1 text-2xl`}
          >
            There’s no product here
          </h2>
          <p className="text-center   font-normal leading-snug pb-4 text-xl">
            Try changing your filters to <br /> see appointments
          </p>
          <div className="flex gap-3 justify-center">
            <button className="w-32 px-3 py-2 bg-indigo-600 hover:bg-indigo-700 transition-all duration-500 rounded-full text-white text-xs font-semibold leading-4 ">
